...
base_path="./img_process/"

cv2.imwrite(base_path+"mask.jpg", mask)
cv2.imwrite(base_path+"box.jpg", src_box)
cv2.imwrite(base_path+"canny.jpg", canned)
cv2.imwrite(base_path+"rotated.jpg", rotated)
cv2.imwrite(base_path+"cropped.jpg", crop)
cv2.imwrite(base_path+"gray.jpg", gray2)